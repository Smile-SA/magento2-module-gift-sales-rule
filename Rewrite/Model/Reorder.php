...
namespace Smile\GiftSalesRule\Rewrite\Model;
...
/**
 * Rewrite Reorder: don't reorder gift order items.
 *
 * It was necessary to copy/paste all the class because of its private properties, methods and constants.
 * A pull request is submitted to Magento https://github.com/magento/magento2/pull/30687 to be able to filter
 * order items and not allow to reorder gift items thanks to a plugin.
 *
 * @author    Pierre Le Maguer <pilem@smile.fr>
 * @copyright 2020 Smile
    ...
    private function addItemsToCart(Quote $cart, ItemCollection $orderItems, string $storeId): void
    {
        ...
        foreach ($orderItemsByProductId as $productId => $orderItems) {
            ...
            foreach ($orderItems as $orderItem) {
                // Rewrite Smile Start: Check if the item is a gift item.
